...
const mailOptions = {
  ...
  html:'<h4>cảm ơn bạn đã sử dụng dịch vụ của chúng tôi</h4><p>Vui long kiểm tra lại những thông tin sau:</p> <p>Địa chỉ giao dịch: {address}</p><p>thông tin liên lạc người nhận: {phone}</p>',
};
